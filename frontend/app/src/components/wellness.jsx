                ...
                <div className="max-w-screen-xl mx-auto py-2">
                    <div className="flex h-16 justify-between items-center">
                        <div className="flex space-x-8 items-center">
                            ...
                            <a href="#" className="text-lg text-gray-600 hover:text-indigo-600 font-semibold">Restaurants</a>
            ...
            <div className="fixed top-2 left-0 right-0 bg-white z-40 shadow-md px-4 pb-4">
                <div className="flex items-center justify-between">
                    <div className="text-left pt-20 pb-4 mx-10">
                        <h2 className="text-4xl font-bold mb-2">Top Wellness Spots in {getCityLabel(selectedCity)}, {getCountryLabel(selectedCountry)}</h2>
                        <p className="text-sm font-semibold">What’s Trending in {getCityLabel(selectedCity)} – Best Wellness Destinations Right Now</p>
                    </div>
