                ...
                <div className="max-w-7xl mx-auto py-2">
                    <div className="flex justify-between bg-transparent h-16 items-center">
                        ...
                        <div className="flex space-x-8 items-center">
                            {sessionValue ? (
                                <>
                                    <button onClick={handleclickProfile} className="text-lg text-white hover:text-indigo-600 font-semibold">Profile</button>
                                ...
                                <>
                                    <button onClick={handleclickLogin} className="text-lg text-white hover:text-indigo-600 font-semibold">Log&nbsp;In</button>
